...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  // Notify main process about committed text state (for rewrite mode hotkey detection)
  sendHasCommittedText: (hasText: boolean) => ipcRenderer.send('has-committed-text', hasText),
